...
#       homepage    => 'http://perlcritic.com',
	...
	resources	=> {
	    bugtracker	=> {
                web => 'https://rt.cpan.org/Public/Dist/Display.html?Name=Perl-Critic-Policy-ErrorHandling-RequireCheckedCall',
##                mailto  => 'wyant@cpan.org',
            },
	    license	=> 'http://dev.perl.org/licenses/',
	    repository	=> {
		type	=> 'git',
		url	=> 'git://github.com/trwyant/perl-Perl-Critic-Policy-ErrorHandling-RequireCheckedCall.git',
		web	=> 'https://github.com/trwyant/perl-Perl-Critic-Policy-ErrorHandling-RequireCheckedCall',
	    },
